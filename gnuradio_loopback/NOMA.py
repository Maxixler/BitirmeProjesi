...
import NOMA_epy_block_0 as epy_block_0  # embedded python block
import NOMA_epy_block_0_0 as epy_block_0_0  # embedded python block
import NOMA_epy_block_1 as epy_block_1  # embedded python block
import sip
import threading



class NOMA(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "NOMA", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("NOMA")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "NOMA")
...
def main(top_block_cls=NOMA, options=None):
