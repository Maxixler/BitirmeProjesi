...
| LDPC Enc -> Multiply Length(x2) -> [Header Formatter + LDPC Payload] ->      |
...
Model       (b=0.35)    (sps=4->1)   (w=2p/100)     (preamble_syms)
                                         |                  |
                           +-------------+                  |
                           | "recovery"                     | "recovery_2"
                           v                                v
                    Soft Const Dec               +---- SIC Aligner (epy_block_1) ----+
                           |                     |  Port 0: recovery_2 (alinan)       |
                    Soft Diff Dec                |  Port 1: user_2_sub (yeniden olus.)|
                    (epy_block_0)                |  Cikis: temizlenmis User 2 sinyali |
                           |                     +------------------------------------+
                    Correlate AC                            |
                           |                                v
