...
class test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_0 = qtgui.time_sink_f(
            1024, #size
            samp_rate, #samp_rate
            "header/payload demux çıkış", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.connect((self.blocks_char_to_float_1_1, 0), (self.qtgui_time_sink_x_0_1, 0))
        self.connect((self.blocks_char_to_float_1_2, 0), (self.qtgui_time_sink_x_0_2, 0))
        self.connect((self.blocks_file_source_0, 0), (self.blocks_throttle2_0, 0))
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.fec_extended_decoder_0, 0))
        self.connect((self.blocks_repack_bits_bb_0, 0), (self.digital_scrambler_bb_0, 0))
        self.connect((self.blocks_repack_bits_bb_0_0, 0), (self.blocks_tagged_stream_mux_0, 0))
        self.connect((self.blocks_repack_bits_bb_0_0_0, 0), (self.blocks_unpack_k_bits_bb_0, 0))
        ...
        self.connect((self.blocks_tagged_stream_mux_0, 0), (self.blocks_repack_bits_bb_0_0_0, 0))
        self.connect((self.blocks_throttle2_0, 0), (self.blocks_stream_to_tagged_stream_0, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0, 0), (self.blocks_char_to_float_1_1, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0, 0), (self.digital_correlate_access_code_tag_xx_0, 0))
        self.connect((self.digital_correlate_access_code_tag_xx_0, 0), (self.blocks_char_to_float_1_0, 0))
    ...
    def set_hdr_format_rx(self, hdr_format_rx):
        self.hdr_format_rx = hdr_format_rx
