...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_0_0_0 = qtgui.time_sink_f(
            1024, #size
            samp_rate, #samp_rate
            "correlate access code giriş", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_time_sink_x_0_0 = qtgui.time_sink_f(
            1024, #size
            samp_rate, #samp_rate
            "correlate access code çıkış", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.connect((self.digital_correlate_access_code_tag_xx_0, 0), (self.blocks_char_to_float_0_0, 0))
    ...
    def get_ldpc_enc_def(self):
        return self.ldpc_enc_def

    def set_ldpc_enc_def(self, ldpc_enc_def):
        self.ldpc_enc_def = ldpc_enc_def

    def get_ldpc_dec_def(self):
        return self.ldpc_dec_def
