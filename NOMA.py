...
class NOMA(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.digital_additive_scrambler_xx_0_1 = digital.additive_scrambler_bb(0x8A, 0x7F, 7, count=0, bits_per_byte=1, reset_tag_key="packet_len")
        self.digital_additive_scrambler_xx_0_0_0 = digital.additive_scrambler_bb(0x8A, 0x7F, 7, count=0, bits_per_byte=1, reset_tag_key="packet_len")
        ...
        self.blocks_file_source_0_0 = blocks.file_source(gr.sizeof_char*1, 'bpsk_transmit_2.txt', False, 0, 0)
        self.blocks_file_source_0_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'bpsk_transmit.txt', False, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_char*1, 'bpsk_receive_2.txt', False)
